              ...
              <FormControl className="flex flex-row gap-3 justify-between">
                <div>
                  <div
                    ...
                    className={`rounded-[5px] text-center px-4 w-[50%] py-2 border border-black hover:text-white hover:bg-black duration-300 cursor-pointer ${
                      tipo == "idaevolta" && "text-white bg-black"
                    }`}
                  >
                    Ida e Volta
                  </div>
                  <div
                    ...
                    className={`rounded-[5px] text-center px-4 w-[50%] py-2 border border-black hover:text-white hover:bg-black duration-300 cursor-pointer ${
                      tipo == "soida" && "text-white bg-black"
                    }`}
                  >
                    Só Ida
                  </div>
              ...
              <Popover>
                <PopoverTrigger asChild>
                  <FormControl className="w-full">
                    ...
                    >
                      {field.value ? field.value : "Selecionar Aeroporto"}
                          ...
                          aeroportos.map((aeroporto) => (
                            <CommandItem
                              ...
                              onSelect={() => {
                                form.setValue(
                                  "origem",
                                  `${aeroporto.sigla} - ${aeroporto.cidade} - ${aeroporto.pais}`
                                );
              ...
              <Popover>
                <PopoverTrigger asChild>
                  <FormControl className="w-full">
                    ...
                    >
                      {field.value ? field.value : "Selecionar Classe"}
                      <CaretSortIcon className="ml-2 h-4 w-4 shrink-0 opacity-50" />
                    </Button>
                  </FormControl>
                </PopoverTrigger>
                <PopoverContent className="w-[200px] p-0">
                  <Command>
                    <CommandInput placeholder="Escolha um" className="h-9" />
                    <CommandList>
                      <CommandEmpty>Nada foi encontrado.</CommandEmpty>
                      <CommandGroup>
                        {["Econômico", "Executivo", "Primeira Classe"].map(
                          (label) => (
                            <CommandItem
                              value={label}
                              key={label}
